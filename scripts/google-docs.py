...
if not os.path.exists(cred_path):
    ...
    print(
        "Set GOOGLE_CREDS_PATH environment variable or place credentials.json in current directory"
    )
    sys.exit(1)
...
def download_as_markdown(doc_id, output_path):
    ...
    request = service.files().export_media(fileId=doc_id, mimeType="text/markdown")
