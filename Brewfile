...
# libpng           xorgproto        libx11           pixman           giflib           jpeg-turbo       webp
# freetype         libxau           libxext          cairo            git              libtiff          leptonica
# fontconfig       libxdmcp         libxrender       eslint           graphite2        little-cms2      pango
# glib             libxcb           lzo              fribidi          harfbuzz         openjpeg         tesseract
