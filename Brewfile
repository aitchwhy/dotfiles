...
# brew "sk"             # grep alternative
brew "mas"             # Mac App Store CLI
brew "atuin", restart_service: :changed # Shell history sync
brew "starship"        # Customizable prompt
brew "zoxide"          # Smart directory navigation
brew "direnv"          # Per-directory environment variables
brew "just"            # Command runner
brew "uv"              # Python package installer/resolver
brew "bat"             # Better cat
brew "eza"             # Better ls
brew "fd"              # Better find
brew "ripgrep"         # Better grep
brew "sd"              # Better sed
brew "dust"            # Disk usage statistics
brew "procs"           # Better ps written in Rust
...
brew "xh"              # Modern HTTP client (HTTPie alternative)
brew "hurl"            # HTTP request testing
...
brew "jo"              # JSON generator from shell

# OpenAPI Tools
brew "prism-cli"       # API mocking and contract testing
brew "kiota"           # HTTP client generator from OpenAPI
brew "spectral-cli"    # OpenAPI linter
brew "openapi-tui"     # Terminal UI for OpenAPI
...
# brew "f1bonacc1/tap/process-compose"  # Process orchestration
brew "nixpacks"        # Container builder
brew "dive"            # Docker layer explorer
brew "podman"          # Alternative container runtime

# Security Tools
brew "gitleaks"        # Secret scanner
brew "semgrep"         # Static analysis
brew "trufflehog"      # Credential finder
...
# Network Tools
brew "rustscan"        # Fast port scanner
brew "speedtest-cli"   # Internet speed test

# Misc Utilities
brew "yazi"            # Terminal file manager
brew "fastfetch"       # System information
brew "wiremock-standalone" # API mocking server
brew "spider-cloud-cli" # Web scraping
...
# Mac App Store Applications (Managed via `mas`)
# Ensure `mas` CLI is installed from Formulae section above or core
