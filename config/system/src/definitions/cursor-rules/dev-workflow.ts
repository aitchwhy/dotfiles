/**
 * Dev Workflow Rule Definition
 *
 * Task Master development workflow guide.
 * Migrated from: .cursor/rules/dev_workflow.mdc
 */
import type { CursorRule } from '@/schema'

export const devWorkflowRule: CursorRule = {
  name: 'dev-workflow' as CursorRule['name'],
  description: 'Guide for using Task Master to manage task-driven development workflows',
  globs: ['**/*'],
  alwaysApply: true,

  content: `# Task Master Development Workflow
