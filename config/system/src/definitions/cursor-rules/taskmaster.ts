/**
 * Taskmaster Rule Definition
 *
 * Comprehensive reference for Taskmaster MCP tools and CLI commands.
 * Migrated from: .cursor/rules/taskmaster.mdc
 */
import type { CursorRule } from '@/schema'

export const taskmasterRule: CursorRule = {
  name: 'taskmaster' as CursorRule['name'],
  description: 'Comprehensive reference for Taskmaster MCP tools and CLI commands.',
  globs: ['**/*'],
  alwaysApply: true,

  content: `# Taskmaster Tool & Command Reference
