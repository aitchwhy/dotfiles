-- Active Lessons Dump
-- Generated: 2025-12-23T20:28:27.478Z
-- Count: 33
...
- Adding 4 stack-specific servers creates a comprehensive toolkit:
  ...
  - **shadcn** → React 19 + Tailwind 4.x component access', 'claude', 7, 1.0000, '2025-12-23 18:57:59');
...
| shadcn | `shadcn-ui-mcp` | React/Tailwind components |', 'claude', 7, 1.0000, '2025-12-23 18:57:59');
...
- **shadcn tools**: React component docs, installation', 'claude', 7, 1.0000, '2025-12-23 18:57:59');
...
| **SonarQube** | `sonarqube-mcp-server` | Code quality analysis |', 'claude', 5, 1.0000, '2025-12-23 19:10:50');
