-- Active Lessons Dump
-- Generated: 2025-12-18T16:55:15.531Z
-- Count: 10
...
4. Optimize ECS/ALB for <2min deploys', 'claude', 1, 1.0000, '2025-12-18 16:55:15');
...
- Aggressive deploy optimization', 'claude', 1, 1.0000, '2025-12-18 16:55:15');
...
3. **Phase 3 (Infra)**: Optimize ECS/ALB for <2min deploys', 'claude', 1, 1.0000, '2025-12-18 16:55:15');
...
- **Modified** `infra/pulumi/src/alb.ts`:
  - interval: 30 → 10
  - deregistrationDelay: 30 → 10', 'claude', 1, 1.0000, '2025-12-18 16:55:15');
