-- Active Lessons Dump
-- Generated: 2025-12-23T20:38:00.480Z
-- Count: 33
...
- Adding 4 stack-specific servers creates a comprehensive toolkit:
  ...
  - **shadcn** → React 19 + Tailwind 4.x component access', 'claude', 10, 1.0000, '2025-12-23 18:57:59');
...
| shadcn | `shadcn-ui-mcp` | React/Tailwind components |', 'claude', 10, 1.0000, '2025-12-23 18:57:59');
...
- **shadcn tools**: React component docs, installation', 'claude', 10, 1.0000, '2025-12-23 18:57:59');
...
| **SonarQube** | `sonarqube-mcp-server` | Code quality analysis |', 'claude', 8, 1.0000, '2025-12-23 19:10:50');
