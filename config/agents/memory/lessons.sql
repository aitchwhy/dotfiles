-- Active Lessons Dump
-- Generated: 2025-12-23T02:17:46.673Z
-- Count: 29
...
8158893 chore(settings): consolidate hooks with p', 'claude', 1, 0.8904, '2025-12-21 02:33:07');
INSERT INTO lessons (id, date, category, lesson, evidence, source, occurrence_count, decay_score, created_at) VALUES (2, '2025-12-12', 'optimization', 'Nix build cache miss problem: Derivation hash includes source code. Split dependencies into separate derivation based on lockfile only.', 'After split, warm builds complete in <60 seconds vs 25+ minutes', 'manual', 2, 0.7750, '2025-12-12');
