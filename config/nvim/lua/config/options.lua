...
-- Disable providers that are optional and causing warnings
vim.g.loaded_ruby_provider = 0    -- Disable Ruby provider
vim.g.loaded_perl_provider = 0    -- Disable Perl provider

-- Python configuration
vim.g.lazyvim_python_lsp = "pyright"  -- LSP Server to use for Python (options: pyright, basedpyright)
vim.g.lazyvim_python_ruff = "ruff"     -- Use ruff formatter and linter for Python
