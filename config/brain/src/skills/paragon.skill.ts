...
export const paragonSkill: SkillDefinition = {
  frontmatter: {
  ...
  sections: [
    {
      heading: 'Overview',
      content: `# PARAGON Enforcement System v3.6
...
> "The only way to go fast is to go well." — Uncle Bob`,
    },
    {
      ...
      content: `| Layer | Mechanism | Trigger |
|-------|-----------|---------|
...
| "I think" | Evidence-based statements |`,
    ...
    {
      heading: 'Clean Code Principles Enforced',
      content: `| Principle | Guard(s) |
|-----------|----------|
