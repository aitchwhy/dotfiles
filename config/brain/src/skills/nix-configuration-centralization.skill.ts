...
export const nixConfigurationCentralizationSkill: SkillDefinition = {
  frontmatter: {
    name: SkillName('nix-configuration-centralization'),
    description:
  ...
  sections: [
    {
      heading: 'Overview',
      content: `# Nix Configuration Centralization`,
    },
    {
      heading: 'Philosophy',
      content: `\`\`\`
...
4. Secrets injected at runtime (never in Nix store)`,
    ...
    {
      heading: 'Problem: Split-Brain Configuration',
      content: `Configuration scattered across multiple files creates drift risk:
...
| Service names as string literals | Typos cause silent failures |`,
    ...
    {
      heading: 'Solution: lib/config/ Module',
...
\`\`\``,
    ...
    {
      heading: 'PARAGON Guards',
      content: `| Guard | Name | Detects |
|-------|------|---------|
...
\`\`\``,
    },
    {
      ...
      content: `When migrating existing code:
...
6. **Run sig-config** - No violations allowed`,
    ...
    {
      heading: 'Anti-Patterns vs Correct Patterns',
      content: `| Anti-Pattern | Correct Pattern |
|--------------|-----------------|
