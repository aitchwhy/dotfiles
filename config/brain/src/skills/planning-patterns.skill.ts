...
export const planningPatternsSkill: SkillDefinition = {
  frontmatter: {
    name: SkillName('planning-patterns'),
    description:
  ...
  sections: [
    {
      ...
      content: `**Never start coding before understanding:**
...
4. How to verify (test strategy)`,
    ...
    {
      heading: 'Planning Phases',
      content: `### Phase 1: Requirements Analysis

\`\`\`markdown`,
    },
    {
      heading: 'Task: [Brief description]',
      content: `### Explicit Requirements (stated)
...
Only proceed after explicit approval.`,
    ...
    {
      heading: 'Planning Templates',
      content: `### Quick Feature (< 50 lines)

\`\`\`markdown`,
    },
    {
      heading: 'Quick Feature: [Name]',
      content: `**Changes:**
