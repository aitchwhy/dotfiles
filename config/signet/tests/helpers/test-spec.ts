...
import { ProjectSpec, ProjectName } from '@/schema/project-spec'
 ...
 */
export const makeSpec = (overrides: Partial<Schema.Schema.Encoded<typeof ProjectSpec>> = {}): typeof ProjectSpec.Type =>
