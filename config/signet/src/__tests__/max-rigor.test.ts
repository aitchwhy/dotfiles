...
import { type TemplateEngine, TemplateEngineLive } from '../layers/template-engine';
...
describe.skip('Max Rigor: Hook Enforcement', () => {
  const hookPath = join(__dirname, '../../../claude-code/evolution/hooks/enforce-versions.ts');
  let tempDir: string;
