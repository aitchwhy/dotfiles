...
--   - keyboard GH repo (https://github.com/jasonrudolph/keyboard/tree/main/hammerspoon)
--   - awesome-hammerspoon GH repo (https://github.com/ashfinal/awesome-hammerspoon)
--   - Evan Travers
