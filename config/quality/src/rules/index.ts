 ...
 *
 * All quality rules with compile-time count assertion.
 */

export { ARCHITECTURE_RULES } from './architecture.rules'
export { EFFECT_RULES } from './effect.rules'
export { EFFECT_XSTATE_RULES } from './effect-xstate.rules'
...
import { EFFECT_XSTATE_RULES } from './effect-xstate.rules'
...
// Actual count: 3 + 8 + 4 + 4 + 1 = 20 rules (TYPE_SAFETY + EFFECT + EFFECT_XSTATE + ARCHITECTURE + OBSERVABILITY)
