...
export const semanticCodebaseSkill: SkillDefinition = {
  frontmatter: {
    name: SkillName('semantic-codebase'),
    description:
  ...
  sections: [
    {
      heading: 'Codebase Navigation Philosophy',
      content: `Before making changes, build a mental model of:
...
4. **History** - Why things are the way they are`,
    },
    {
      ...
      content: `### Project Structure Discovery
...
\`\`\``,
    ...
    {
      heading: 'Semantic Search Patterns',
      content: `### Find by Behavior
...
\`\`\``,
    ...
    {
      heading: 'Context Building Protocol',
...
\`\`\``,
    ...
    {
      heading: 'AST-Based Analysis',
      content: `### Using ast-grep
...
\`\`\``,
    ...
    {
      heading: 'Codebase Health Metrics',
      content: `\`\`\`bash
...
\`\`\``,
    ...
    {
      heading: 'Documentation Discovery',
      content: `\`\`\`bash
# Find README files
fd README --type f
...
\`\`\``,
    ...
    {
      heading: 'Quick Navigation Commands',
      content: `\`\`\`bash
...
\`\`\``,
    ...
    {
      heading: 'Effect-TS Project Patterns',
      content: `When working on Effect-TS projects:
...
\`\`\``,
    ...
    {
      heading: 'Checklist Before Changes',
      content: `- [ ] Understand file's role in architecture
