...
\`\`\``,
    },
    {
      ...
      content: `The upgrade skill looks for:
...
\`\`\``,
    ...
    {
      heading: 'Manual Check Process',
      content: `When automated checks aren't available:
...
4. Review release notes for breaking changes`,
    ...
    {
      heading: 'Related',
      content: `- \`config/quality/AGENTS.md\` - Main bootloader (SSOT)
