...
export const secretsManagementSkill: SkillDefinition = {
  frontmatter: {
    name: SkillName('secrets-management'),
  ...
  sections: [
    {
      heading: 'Overview',
      content: `# Secrets Management (sops-nix)
...
\`\`\``,
    ...
    {
      heading: 'Nix Module Configuration',
      content: `### Darwin Module
...
\`\`\``,
    },
    {
      ...
      content: `### Environment Variable Injection
...
\`\`\``,
    ...
    {
      heading: 'Operations',
      content: `### Edit Encrypted Secrets
...
\`\`\``,
    },
    {
      ...
      content: `### "Failed to get the data key"
