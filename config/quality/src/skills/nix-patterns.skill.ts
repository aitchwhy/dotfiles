...
export const nixPatternsSkill: SkillDefinition = {
  frontmatter: {
    name: SkillName('nix-patterns'),
...
\`\`\``,
    ...
    {
      heading: 'Flake Template (flake-parts)',
      content: `\`\`\`nix
{
  inputs = {
...
\`\`\``,
    ...
    {
      heading: 'Darwin Configuration (flake/darwin.nix)',
      content: `\`\`\`nix
...
\`\`\``,
    ...
    {
      heading: 'Development Shell (flake/devshells.nix)',
      content: `\`\`\`nix
{ inputs, ... }:
{
...
\`\`\``,
    ...
    {
      heading: 'Home Manager Module Pattern',
      content: `\`\`\`nix
{ config, lib, pkgs, ... }:
let
...
\`\`\``,
    ...
    {
      heading: 'Version Policy (December 2025)',
      content: `- **nixpkgs**: \`nixos-unstable\`
...
\`\`\``,
    ...
    {
      heading: 'See Also',
      content: `- \`secrets-management\` - sops-nix patterns for dotfiles
