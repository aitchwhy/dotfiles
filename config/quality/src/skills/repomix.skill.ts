...
export const repomixSkill: SkillDefinition = {
  frontmatter: {
    name: SkillName('repomix'),
    description:
      'Repomix MCP server tools and patterns. Pack codebases for AI analysis, generate skills, optimize token usage.',
    allowedTools: ['mcp__repomix__*', 'Read', 'Bash', 'Write', 'Edit'],
    tokenBudget: 700,
  },
  sections: [
    {
      heading: 'When to Use',
      content: `| Scenario | Approach |
|----------|----------|
...
\`\`\``,
    ...
    {
      heading: 'Include Patterns by Project Type',
      content: `**API/Backend**:
\`\`\`json
...
\`\`\``,
    ...
    {
      heading: 'Compression Strategy',
      content: `| Content Type | Compression Savings |
|--------------|---------------------|
...
- Comments contain important context`,
    ...
    {
      heading: 'Config File',
      content: `Place \`repomix.config.json\` in project root:
