...
| Need                     | Action                                                     |
| ------------------------ | ---------------------------------------------------------- |
| **PARAGON guards**       | Read `config/quality/generated/claude/skills/paragon.md`     |
| Stack versions           | Read `config/quality/src/stack/versions.ts`                  |
| Stack rules              | Read `config/quality/docs/stack.md`                          |
| Pattern skills           | Read `config/quality/generated/claude/skills/{skill}.md`     |
| Agent personas           | Read `config/quality/generated/claude/personas/{persona}.md` |
| **Canonical memories**   | Read `config/quality/generated/claude/memories.md`           |
| **Critic-mode protocol** | Read `config/quality/generated/claude/critic-mode.md`        |
