...
Configuration and Standards are enforced programmatically via `config/quality`. Do not document standards in Wiki/README without backing them by active Memory/Rule in Brain. Brain generates LLM prompts (GEMINI.md) to ensure AI alignment.
