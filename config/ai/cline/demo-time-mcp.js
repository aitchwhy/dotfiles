...
console.log("- Server Name: github.com/modelcontextprotocol/servers/tree/main/src/time");
console.log("- Command: uvx mcp-server-time");
console.log("- Configuration File: ~/dotfiles/config/ai/cline/cline_mcp_settings.json");
